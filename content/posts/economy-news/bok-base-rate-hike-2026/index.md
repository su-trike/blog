...
저라면 오늘 확인할 건 계산기가 아니라 대출약정서라고 봐요. 위 표의 금액은 **인상분이 100% 전가됐을 때의 상한선**이고, 실제로는 내 대출이 어떤 금리에 연동돼 있느냐에서 갈리거든요.
...
3. **COFIX 연동인지 금융채 연동인지 확인하세요.** 연동 지표에 따라 반영 시점이 갈려요. 거래 은행 앱이나 영업점 방문으로 확인할 수 있어요.
