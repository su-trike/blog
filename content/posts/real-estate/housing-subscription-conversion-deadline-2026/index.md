---
title: "2026 청약통장 전환특례 9월 30일 마감, 실적은 절반만 인정돼요"
...
draft: false
tags: ["무주택", "청약", "기한", "개정사항"]
summary: "9월 30일 전환 마감. 실적은 가는 방향 따라 절반만 인정돼요."
cover:
  image: "housing-subscription-conversion-deadline-2026-thumbnail.png"
  alt: "청약통장 전환특례 마감일 2026년 9월 30일을 보여주는 대표 이미지"
  caption: "마감은 2026년 9월 30일"
---

# 2026 청약통장 전환특례 9월 30일 마감, 실적은 절반만 인정돼요

📌 2026년 8월 26일 기준

청약예금·청약부금·청약저축을 주택청약종합저축으로 바꾸는 창구가 ==2026년 9월 30일==에 닫혀요. 저도 멀쩡한 통장을 왜 굳이 갈아타야 하나 싶어서 국토교통부와 주택도시기금 원문을 다 열어봤어요.
...
이 마감일은 「주택공급에 관한 규칙」 본문에도 부칙에도 없습니다. 규칙이 정한 것은 전환할 때 실적을 어떻게 승계하느냐이고, 기한은 제도 운영상의 한시 조치예요. ==법에 적힌 날짜가 아니라서== 실제로 한 번 연장됐습니다.
...
제도 시행 이후 22개월 동안 26만여 좌가 줄었어요. 다만 이 감소분을 '전환한 사람 수'로 읽으면 안 됩니다. 당첨 해지, 중도 해지, 사망 해지가 다 섞여 있고, 청약홈은 전환 건수를 따로 떼어 공표하지 않고, 이 통계도 참고 자료라고 밝혀 두었습니다.
...
![전환 방향별로 민영주택과 국민주택 청약 실적이 어디까지 인정되는지 비교한 표 이미지](conversion-direction-credit-compare.png "가는 방향에 따라 인정되는 실적이 정반대로 나뉩니다")
...
1. 내 통장이 청약예금·청약부금·청약저축 중 무엇인지 확인해요. 인정 범위가 여기서 달라져요.
...
공식 안내를 다 읽어도 걸리기 쉬운 것이 다섯 가지 있어요.
...
2000년 3월 27일 전에 가입한 청약예금·청약부금은 옛 규칙을 따르도록 부칙이 정하고 있어요. 가족 간 승계를 염두에 두고 있다면 그 옛 규칙이 어디까지 허용하는지 은행에 먼저 물어보세요.

**다섯째, 소득공제를 받아 온 사람은 추징을 확인해야 해요.** 가입일부터 5년 안에 해지하면 납입액 누계의 6%가 추징될 수 있는데, 전환은 '전환해지 + 전환가입' 절차를 거칩니다. 가입한 지 5년이 안 됐다면 이 전환해지가 추징 대상에 들어가는지 창구에서 반드시 확인하고 진행하세요.
